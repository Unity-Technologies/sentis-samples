...
namespace Unity.InferenceEngine.Samples.TTS.Handlers
{
    public static class PhonemesHandler
    {
        ...
        const string esPeakDataPath = "Packages/com.unity.ai.inference/Samples/TTS/Data/espeak-ng-data";
        ...
        static string GetEspeakPathForCurrentPlatform()
        {
            if (Application.platform == RuntimePlatform.OSXEditor || Application.platform == RuntimePlatform.OSXPlayer)
                return "Packages/com.unity.ai.inference/Samples/TTS/Data/Libs/MacOs/espeak-ng";
