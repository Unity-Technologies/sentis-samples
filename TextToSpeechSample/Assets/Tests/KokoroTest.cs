...
namespace Unity.InferenceEngine.Samples.TTS.Tests
{
    public class KokoroTest
    {
        ...
        const string k_OutputWavPathShort = "Packages/com.unity.ai.inference/Samples/TTS/Tests/Output/kokoro_short.wav";
        const string k_OutputWavPathSpeed = "Packages/com.unity.ai.inference/Samples/TTS/Tests/Output/kokoro_speed.wav";
